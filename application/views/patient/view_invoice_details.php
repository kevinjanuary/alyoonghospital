	...
	<div class="row">
            ...
            <tr>
                ...
                <td align="right">
                    ...
                    <h5><?php echo get_phrase('status'); ?> : <strong style="color:#009900"><?php echo $row['status']; ?></strong>&nbsp;<img src="<?php echo base_url() ?>uploads/approve.jpg" style="max-height:20px;"></h5>
                </td>
            </tr>
        </table>
        <hr>
