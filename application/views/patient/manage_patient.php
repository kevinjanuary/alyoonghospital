                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>patient/manage_patient/edit/<?php echo $row['patient_id'];?>"
                            	...
                            	<a href="<?php echo base_url();?>patient/manage_patient/delete/<?php echo $row['patient_id'];?>" onclick="return confirm('delete?')"
