...
<?php echo form_open(base_url() . 'patient/manage_profile/update_profile_info/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<?php echo form_open(base_url() . 'patient/manage_profile/change_password/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>	
