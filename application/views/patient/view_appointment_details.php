				<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;<?php echo get_phrase("appointment_information");?>
					...
					<!-- <a href="<?php echo base_url();?>patient/add_appointment" 
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('request_new_appointment');?>
                    </a>-->
