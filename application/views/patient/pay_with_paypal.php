...
<div align="right">       
 <?php echo form_open(base_url() . 'patient/list_invoice/make_payment/' . $row['invoice_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
<input type="hidden" name="invoice_id" value="<?php echo $row['invoice_id'];?>" />
<input type="hidden" name="amount" value="<?php echo $grand_total;?>" />
<button type="submit" class="btn btn-primary  btn-sm"><i class="fa fa-paypal"></i> <?php echo get_phrase('pay_with_paypal');?></button>
<?php echo form_close();?>

<img src="<?php echo base_url() ?>uploads/paypal.jpg" style="max-height:40px;">
</div>	
