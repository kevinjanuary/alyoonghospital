		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                ...
                <div class="box-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>doctor/manage_prescription/edit/do_update/<?php echo $row['prescription_id'];?>" class="form-horizontal validatable">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>patient/view_prescription/edit/<?php echo $row['prescription_id'];?>" class="btn btn-blue">
