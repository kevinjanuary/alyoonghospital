				<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase('add_pharmacist');?> 
							<a href="<?php echo base_url();?>admin/list_pharmacist" 
                     class="btn btn-orange btn-xs"><i class="fa fa-link"></i>&nbsp;<?php echo get_phrase('list_pharmacists');?>
                    </a></div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
							
                                <div class="panel-body">
								<?php echo form_open(base_url() . 'admin/manage_pharmacist/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
