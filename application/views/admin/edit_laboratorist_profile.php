				<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase('edit_laboratorist_profile');?>
                    ...
                    <?php echo form_open(base_url() . 'admin/manage_laboratorist/do_update/'.$row['laboratorist_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                  <input class="form-control select2 m-r-10" name="date_of_birth"  type="date" value="<?php echo $row['date_of_birth']; ?>" id="example-date-input" required>
                                    </div>
                                </div>
