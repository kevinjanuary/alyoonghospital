...
?>
                    ...
                    <?php echo form_open(base_url() . 'admin/manage_doctor/do_update/'.$row['doctor_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
					 ...
					 <div class="col-sm-12">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" id="example-text" name="id_card" class="form-control m-r-10" value="<?php echo $row ['id_card']; ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="password" id="pwd" name="password" class="form-control"  value="<?php echo $row ['password']; ?>">
                                    </div>
                                </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-info"><?php echo get_phrase('update_doctor');?></button>
                        </div>
                    </form>
					<br>
                    <?php endforeach;?>
