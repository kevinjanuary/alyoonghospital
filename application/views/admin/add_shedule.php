...
<?php echo form_open(base_url() . 'admin/add_shedule/create' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
									<div class="form-group">
                                    <label class="col-sm-12"><?php echo get_phrase('doctor');?>*</label>
                                    <div class="col-sm-12">
                                       <select class="select2 m-b-20 m-r-10 form-control" name="doctor_id" data-style="btn-primary btn-outline" required>
								 ...
								 <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control " name="avail_day" type="date" value="2011-08-19" id="example-date-input" required>
                                    </div>
                                </div>
