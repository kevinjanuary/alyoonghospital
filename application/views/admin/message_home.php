                    ...
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase('all_messages');?>
							 <a href="<?php echo base_url(); ?>admin/message/message_new" class="btn btn-green btn-sm "> <i class="fa fa-plus"></i> <?php echo get_phrase('compose_new_message'); ?>
...
<table class="table" >
                ...
                ?>
					...
					<td><a href="<?php echo base_url(); ?>admin/message/message_read/<?php echo $row['message_thread_code']; ?>"><button type="button" class="btn btn-info btn-xs"><i class="fa fa-envelope"></i>&nbsp;<?php echo get_phrase ('read_message'); ?></button></a>
					</td>
					<td>  <a href="<?php echo base_url(); ?>admin/message/message_read/<?php echo $row['message_thread_code']; ?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-mail-reply-all"></i></button></a></td>
					</tr>
		  <?php endforeach; ?>
                    </tbody>
                </table>
