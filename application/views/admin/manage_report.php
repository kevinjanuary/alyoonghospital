...
<div class="panel-body">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>admin/manage_report/delete/<?php echo $row['report_id'];?>" onclick="return confirm('delete?')"
                    ...
                    <?php echo form_open('admin/manage_report/create/' , array('class' => 'form-horizontal validatable'));?>
