...
?>
                    ...
                    <?php echo form_open(base_url() . 'admin/assign_bed/do_update/'.$row['assign_bed_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
