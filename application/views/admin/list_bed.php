 				<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase('list_all_bed');?>
 								...
 								<table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo get_phrase('bed_ward');?></th>
									...
									<?php 
                                        ...
                                        <tr>
											...
											<td><?php echo $this->crud_model->get_type_name_by_id('bed_ward',$row['bed_ward_id']);?></td>
                                            ...
                                            <td>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/add_bed/delete/<?php echo $row['add_bed_id'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i> </button></a>
