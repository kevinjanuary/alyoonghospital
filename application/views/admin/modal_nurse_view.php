...
?>
                    ...
                    <?php echo form_open(base_url() . 'admin/manage_nurse/do_update/'.$row['nurse_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
					 ...
					 <div class="col-sm-12">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-info"><?php echo get_phrase('update_nurse');?></button>
                        </div>
                    </form>
					<br>
                    <?php endforeach;?>
