				...
				<?php echo form_open(base_url() . 'admin/invoice_add/create' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                            <input type="number" class="form-control" name="vat_percentage" value="0" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                    <input type="number" class="form-control" name="discount_amount"  value="0" required>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="entry_description[]"  value="" 
                                   placeholder="<?php echo get_phrase('description'); ?>" required>
                        </div>
                        <div class="col-md-4">
						 ...
						 <div class="col-sm-2">
                            <button type="button" class="btn btn-danger btn-xs btn-circle" onclick="deleteParentElement(this)">
                ...
                <hr>
 					...
 					<div class="form-group">
                    <div class="col-sm-offset-3 col-sm-8">
                        <button type="submit" class="btn btn-success btn-sm btn-rounded" id="submit-button">
                           <i class="fa fa-save"> </i>&nbsp;<?php echo get_phrase('save'); ?></button>
