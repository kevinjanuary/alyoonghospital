				<div class="row">
					...
					<a href="<?php echo base_url();?>admin/manage_receptionist" 
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_receptionist');?>
                    </a>
...
<?php foreach($receptionists as $row):?>			
...
<table class="table" width="1030" border="1">
 ...
 <div class="alert alert-default" align="center"><img src="<?php echo base_url() ?>uploads/logo.png"  class="img-circle" width="80" height="80"/>
  ...
  <tr>
    <td width="180" rowspan="4"><img src="<?php echo $this->crud_model->get_image_url('receptionist',$row['receptionist_id']);?>" alt="user" class="img-thumbnail img-responsive" width="260" height="260"></td>
 ...
 <button class="btn btn-sm btn-outline btn-rounded btn-info" type="button" data-toggle="collapse" data-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample"><?php echo get_phrase ('get_password');?></button>
  ...
  <tr>
    <td colspan="3"><div class="alert alert-info">DOWNLOAD FULL DOCUMENTS ABOUT DOCTOR </div>&nbsp;&nbsp;Download Full Document:&nbsp;<a href="<?php echo base_url().'uploads/receptionist_image/'.$row['file_name']; ?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-download"></i></button></a>
	<hr>
	</td>
  </tr>
</table>
