				<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase('edit_accountant_profile');?>
				...
				<?php foreach($accountants as $row): ?>	
                    ...
                    <?php echo form_open(base_url() . 'admin/manage_accountant/do_update/'.$row['accountant_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
