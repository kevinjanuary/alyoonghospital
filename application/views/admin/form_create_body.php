...
<div class="row">
    <div class="col-md-12">
        <?php echo form_open('admin/invoice_add/create', array('class' => 'form-horizontal form-groups validate invoice-add', 'enctype' => 'multipart/form-data')); ?>
        <div class="form-group">
...
<script>
    ...
    function add_entry()
    {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/get_form_element/' + element_type,
