<div class="row">
   <div class="col-sm-12">
		<div class="panel panel-info">
             <div class="panel-heading"> <?php echo get_phrase('add_nurse');?> 
				<a href="<?php echo base_url();?>admin/list_nurse" class="btn btn-orange btn-xs">
					<i class="fa fa-link"></i>&nbsp;<?php echo get_phrase('list_nurses');?></a></div>
							
                                <div class="panel-body">
								<?php echo form_open(base_url() . 'admin/manage_nurse/create/' , 
								...
								<div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" name="date_of_birth" type="date" value="2011-08-19" id="example-date-input" required>
                                    </div>
                                </div>
