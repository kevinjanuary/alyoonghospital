	...
	<a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/list_invoice/delete/<?php echo $row['invoice_id'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i> </button></a>
