...
?>
                    ...
                    <?php echo form_open(base_url() . 'admin/add_bed/do_update/'.$row['add_bed_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                          ...
                          <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                       <select class="form-control" name="bed_ward_id" data-style="btn-primary" required>
                                         <option value=""><?php echo get_phrase('select_bed_ward'); ?></option>
                                <?php
                                $bed_ward = $this->db->get('bed_ward')->result_array();
                                foreach ($bed_ward as $row3):
                                    ?>
                                    <option value="<?php echo $row3['bed_ward_id']; ?>"
                                            <?php if ($row['bed_ward_id'] == $row3['bed_ward_id']) echo 'selected'; ?>>
                                                <?php echo $row3['name']; ?>
                                    </option>
                                    <?php
                                endforeach;
