...
?>
        ...
        <?php echo form_open(base_url(). 'admin/noticeboard/do_update/'.$row['notice_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <div class="form-group">
                    <label class="col-sm-12"><?php echo get_phrase('title');?></label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="notice_title" value="<?php echo $row['notice_title'];?>"/>
                    </div>
                </div>
                <div class="form-group">
                   <label class="col-sm-12"><?php echo get_phrase('notice');?></label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                   <label class="col-sm-12"><?php echo get_phrase('send_sms_to_all');?></label>
                    <div class="col-sm-12">
