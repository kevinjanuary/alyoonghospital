                     ...
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_new_document');?>
						...
						?>
                                        <tr>
                                            ...
                                            <td>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/add_document/delete/<?php echo $row['add_document_id'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i> </button></a>
