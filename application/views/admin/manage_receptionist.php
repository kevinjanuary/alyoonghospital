				<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase('add_receptionist');?> 
							<a href="<?php echo base_url();?>admin/list_receptionist" 
                     class="btn btn-orange btn-xs"><i class="fa fa-link"></i>&nbsp;<?php echo get_phrase('list_receptionists');?>
                    </a></div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control select2 m-r-10" name="date_of_birth" type="date" value="2011-08-19" id="example-date-input" required>
                                    </div>
                                </div>
                            ...
                            <input type="text" id="example-text" name="id_card" class="form-control m-r-10" placeholder="eg national ID card, International Passport, Voters card " required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                       <select class="selectpicker m-b-20 m-r-10 form-control" name="gender" data-style="btn-primary btn-outline" required>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                       <select class="selectpicker m-b-20 m-r-10 form-control" name="department_id" data-style="btn-primary btn-outline" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                             <textarea class="form-control m-r-10" rows="15" name="address" placeholder="Enter Address ..." required></textarea>
