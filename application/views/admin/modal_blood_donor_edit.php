...
?>
                    ...
                    <?php echo form_open(base_url() . 'admin/add_donor/do_update/'.$row['blood_donor_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
