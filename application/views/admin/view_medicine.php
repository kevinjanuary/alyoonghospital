						...
						foreach($medicines as $row):
							...
							<tr>
								...
								<td><?php echo $row['manufacturing_company'];?></td>
								 <td>
						<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/medicine/delete/<?php echo $row['medicine_id'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i> </button></a>

                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_medicine_edit/<?php echo $row['medicine_id'];?>');"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i> </button></a></td>
