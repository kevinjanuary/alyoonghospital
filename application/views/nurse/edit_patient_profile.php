				...
				<div class="row">
                    ...
                    <?php echo form_open(base_url() . 'nurse/manage_patient/do_update/'.$row['patient_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                       <select class="selectpicker m-b-20 m-r-10 form-control" name="sex" data-style="btn-primary btn-outline" required>
                                         <option data-tokens="<?php echo $row ['sex']; ?>"><?php echo $row ['sex']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control select2 m-r-10" name="birth_date" type="date" value="<?php echo $row ['birth_date']; ?>" id="example-date-input" required>
										<input type="text" id="example-text" name="age" class="form-control m-r-10" value="<?php echo $row ['age']; ?>" required>
										<input type="text" id="example-text" name="place_of_birth" class="form-control m-r-10" value="<?php echo $row ['place_of_birth']; ?>" required>
                            ...
                            <input class="form-control select2 m-r-10" name="issue_on" type="date" value="2011-08-19" id="example-date-input" value="<?php echo $row ['issue_on']; ?>">
                                                 </div>
                                                </div>
								...
								<div class="col-md-6">
                                    ...
                                    <label class="control-label"> <?php echo get_phrase('marital_status');?>*</label>
                                       <select class="selectpicker m-b-20 m-r-10 form-control" name="marital_status" data-style="btn-primary btn-outline" required>
                                         <option data-tokens="<?php echo $row ['marital_status']; ?>"><?php echo $row ['marital_status']; ?></option>
										<option data-tokens="Married">Married</option>
                                        <option data-tokens="Single">Single</option>
                                        <option data-tokens="Divorced">Divorced</option>
                                        <option data-tokens="Engaged">Engaged</option>
                                    </select>
                                    </div>
                                </div>
								...
								<div class="col-md-6">
                                    ...
                                    <label class="control-label"> <?php echo get_phrase('religion');?>*</label>
                                       <select class="selectpicker m-b-20 m-r-10 form-control" name="religion" data-style="btn-primary btn-outline" required>
		...
		<div class="alert alert-info"><?php echo get_phrase('medical_history');?>*</div>
								<div class="form-group">
								 ...
								 <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control select2 m-r-10" name="date_of_last_admission" type="date" value="<?php echo $row ['date_of_last_admission']; ?>" id="example-date-input" >
                                    </div>
                                </div>
