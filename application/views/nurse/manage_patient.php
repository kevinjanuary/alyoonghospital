                     ...
                     class="btn btn-orange btn-xs"><i class="fa fa-link"></i>&nbsp;<?php echo get_phrase('view_patients');?>
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
								               <?php echo form_open(base_url() . 'nurse/manage_patient/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
?>  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control select2 m-r-10" name="birth_date" type="date" value="2011-08-19" id="example-date-input" required>
                            ...
                            <input class="form-control select2 m-r-10" name="issue_on" type="date" value="2011-08-19" id="example-date-input" placeholder="Issue Date" >
                                                 </div>
                                                </div>
		...
		<div class="alert alert-info"><?php echo get_phrase('medical_history');?>*</div>
								<div class="form-group">
								 ...
								 <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control select2 m-r-10" name="date_of_last_admission" type="date" value="2011-08-19" id="example-date-input" >
                                    </div>
                                </div>
                             ...
                             <textarea class="form-control m-r-10" rows="5" name="diagnose" placeholder="Enter diagnose ..." ></textarea>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                       <select class="selectpicker m-b-20 m-r-10 form-control" name="department_id" data-style="btn-primary btn-outline" >
