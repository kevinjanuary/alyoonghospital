...
<?php echo form_open(base_url() . 'nurse/manage_profile/update_profile_info/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
          
					<div class="form-group"> 
					 <div class="col-sm-12">
  		  			 <input type='file' class="form-control" value="" name="userfile" onChange="readURL(this);" />
       				 <img id="blah" src="<?php echo $this->crud_model->get_image_url('nurse', $row['nurse_id']); ?>" alt="" height="200" width="200"/>
					</div>
					</div>	
...
<?php echo form_open(base_url() . 'nurse/manage_profile/change_password/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>	
