                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>nurse/manage_blood_donor/edit/<?php echo $row['blood_donor_id'];?>"
                            	...
                            	<a href="<?php echo base_url();?>nurse/manage_blood_donor/delete/<?php echo $row['blood_donor_id'];?>" onclick="return confirm('delete?')"
