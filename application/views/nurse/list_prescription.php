        ...
        <?php foreach ($prescription_info as $row) { ?>   
            <tr>
                ...
                <td>
						                             ...
						                             <a href="<?php echo base_url();?>nurse/view_prescription_details/<?php echo $row['prescription_id'];?>"><button type="button" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-print"></i> </button></a>
