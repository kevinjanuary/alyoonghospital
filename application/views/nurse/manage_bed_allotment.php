                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>nurse/manage_bed_allotment/edit/<?php echo $row['bed_allotment_id'];?>"
                            	...
                            	<a href="<?php echo base_url();?>nurse/manage_bed_allotment/delete/<?php echo $row['bed_allotment_id'];?>" onclick="return confirm('delete?')"
