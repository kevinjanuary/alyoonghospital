                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>nurse/manage_bed/edit/<?php echo $row['bed_id'];?>"
                            	...
                            	<a href="<?php echo base_url();?>nurse/manage_bed/delete/<?php echo $row['bed_id'];?>" onclick="return confirm('delete?')"
