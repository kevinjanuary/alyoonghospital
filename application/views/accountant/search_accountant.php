 				<div class="row">
                    <div class="col-sm-12">
                     ...
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('all_accountant');?>
                    </a>
					</div>
...
<noscript><button type="submit" class="btn btn-green btn-icon icon-left"><i class="fa fa-search"></i><?php echo get_phrase('search_accountant');?></button></noscript>
...
<hr>
 	<table id="example23" class="display nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <?php
                        $department =  $this->db->get_where('accountant' , array('department_id'=>$department_id))->result_array();
                        foreach ($department as $row):
                            ?>
                            <tr>
