                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>accountant/manage_invoice/edit/<?php echo $row['invoice_id'];?>"
                            	...
                            	<a href="<?php echo base_url();?>accountant/manage_invoice/delete/<?php echo $row['invoice_id'];?>" onclick="return confirm('delete?')"
