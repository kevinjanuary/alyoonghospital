        ...
        <div class="col-md-12">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open(base_url() . 'accountant/list_invoice/update/' . $param2, array('class' => 'form-horizontal form-groups validate invoice-edit', 'enctype' => 'multipart/form-data')); ?>
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="entypo-calendar"></i></span>
										<input class="form-control m-r-10" name="creation_timestamp" type="date" value="<?php echo $row['creation_timestamp']; ?>" id="example-date-input" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="entypo-calendar"></i></span>
			<input class="form-control m-r-10" name="due_timestamp" type="date" value="<?php echo $row['due_timestamp']; ?>" id="example-date-input" required>
