 				<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase('list_accountant_by_department');?>
							 <a href="<?php echo base_url();?>accountant/list_accountant" 
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('all_accountants');?>
                    </a>
					</div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
								...
								<?php echo form_open(base_url() . 'accountant/search_accountant');?>					
...
<noscript><button type="submit" class="btn btn-green btn-icon icon-left"><i class="entypo-search"></i><?php echo get_phrase('get_accountant_list');?></button></noscript>
...
<hr>
 	<table id="example23" class="display nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <?php
                        $accountant =  $this->db->get_where('accountant' , array('department_id'=>$department_id))->result_array();
                        foreach ($accountant as $row):
                            ?>
                            <tr>
                                <td><?php echo $row['accountant_id']; ?></td>
                                <td><img src="<?php echo $this->crud_model->get_image_url('accountant', $row['accountant_id']); ?>" class="img-circle" width="30" height="30" /></td>
                                ...
                                <td>
																								 ...
																								 <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/modal_accountant_message/<?php echo $row['accountant_id']; ?>');"><button type="button" class="btn btn-info btn-circle btn-sm"><i class="fa fa-envelope"></i></button></a>
