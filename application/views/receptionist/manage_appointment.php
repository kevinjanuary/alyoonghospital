                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>doctor/manage_appointment/edit/<?php echo $row['appointment_id'];?>"
                            	...
                            	<a href="<?php echo base_url();?>doctor/manage_appointment/delete/<?php echo $row['appointment_id'];?>" onclick="return confirm('delete?')"
