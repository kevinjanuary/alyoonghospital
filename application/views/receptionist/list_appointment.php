 				<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"><i class="fa fa-list"></i>&nbsp;  <?php echo get_phrase('list_appointments');?>
                     ...
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_appointment');?>
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
								...
								<?php echo form_open(base_url() . 'receptionist/list_appointment');?>					
                        ...
                        foreach ($department as $row):
                            ?>
                                        <tr>
                                            ...
                                            <td>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>receptionist/add_appointment/delete/<?php echo $row['appointment_id'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i> </button></a>

                             <a href="<?php echo base_url();?>receptionist/edit_appointment_details/<?php echo $row['appointment_id'];?>"><button type="button" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-edit"></i> </button></a>
							 
                             <a href="<?php echo base_url();?>receptionist/view_appointment_details/<?php echo $row['appointment_id'].'/'. $row['patient_id'].'/'.$row['department_id'].'/'. $row['doctor_id'].'/';?>"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-link"></i> </button></a>
