 				<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase('list_doctor_by_department');?>
                     ...
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('all_doctors');?>
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
								...
								<?php echo form_open(base_url() . 'receptionist/search_doctor');?>					
...
<hr>
 	<table id="example23" class="display nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <?php
                        $department =  $this->db->get_where('doctor' , array('department_id'=>$department_id))->result_array();
                        foreach ($department as $row):
                            ?>
                            <tr>
                                <td><?php echo $row['doctor_id']; ?></td>
                                <td><img src="<?php echo $this->crud_model->get_image_url('doctor', $row['doctor_id']); ?>" class="img-circle" width="30" height="30" /></td>
