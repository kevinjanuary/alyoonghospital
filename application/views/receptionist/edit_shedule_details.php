				<div class="row">
					...
					<?php foreach($edit as $row):?>			
						...
						<?php echo form_open(base_url() . 'receptionist/add_shedule/do_update/'.$row['shedule_id'] , array('class' => 'form-horizontal form-groups-bordered 			validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
