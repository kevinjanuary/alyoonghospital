...
foreach ($edit_data as $row):
    ...
    <?php echo form_open(base_url() . 'receptionist/message/send_new/', array('class' => 'form', 'enctype' => 'multipart/form-data')); ?>
                                                   <div class="panel-body table-responsive">

				   <div align="center">
		<img src="<?php echo $this->crud_model->get_image_url('receptionist' , $row['receptionist_id']);?>" class="img-circle" width="100" height="100" />
		</div>
		<br>

                    <div class="form-group">
                         <label class="col-md-12" for="example-text"><?php echo get_phrase('receptionist_name'); ?></label>

                        <div class="col-sm-12">
      					<input type="hidden" class="form-control" name="reciever"  value="receptionist-<?php echo $row['receptionist_id']; ?>" readonly="true">
