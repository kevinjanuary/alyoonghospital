...
<?php echo form_open(base_url() . 'pharmacist/add_category/create' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
								
								<div class="form-group">
                                    <label class="col-md-12"><?php echo get_phrase('category_name');?>*</label>
                                    <div class="col-md-12">
