                     ...
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_new_category');?>
						...
						?>
                                        <tr>
                                            ...
                                            <td>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>pharmacist/add_category/delete/<?php echo $row['medicine_category_id'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i> </button></a>                                         
             </tr>
			 <?php endforeach;?>
</tbody>
