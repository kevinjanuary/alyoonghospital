                    ...
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <?php echo get_phrase('chat_page');?>
							 <a href="<?php echo base_url(); ?>laboratorist/message/message_new" class="btn btn-green btn-sm "> <i class="fa fa-plus"></i> <?php echo get_phrase('compose_new_message'); ?></a>
</div>
...
<?php echo form_open(base_url() . 'laboratorist/message/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>
                                <div class="panel-body table-responsive">
