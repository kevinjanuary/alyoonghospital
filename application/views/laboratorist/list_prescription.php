                ...
                <td>
                    <a  onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/edit_prescription/<?php echo $row['prescription_id'] ?>');" 
                        ...
                        <i class="fa fa-edit"></i></a>
						                             ...
						                             <a href="<?php echo base_url();?>doctor/view_prescription_details/<?php echo $row['prescription_id'];?>"><button type="button" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-print"></i> </button></a>




						
	<a href="#" onclick="confirm_modal('<?php echo base_url();?>doctor/list_prescription/delete/<?php echo $row['prescription_id'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i> </button></a>
