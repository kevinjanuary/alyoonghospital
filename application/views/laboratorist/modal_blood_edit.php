...
?>
                    ...
                    <?php echo form_open(base_url() . 'laboratorist/add_blood/do_update/'.$row['blood_group_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
