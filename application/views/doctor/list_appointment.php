                     ...
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_appointment');?>
						...
						?>
                                        <tr>
                                            ...
                                            <td>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>doctor/add_appointment/delete/<?php echo $row['appointment_id'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i> </button></a>

                             <a href="<?php echo base_url();?>doctor/edit_appointment_details/<?php echo $row['appointment_id'];?>"><button type="button" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-edit"></i> </button></a>
							 
                             <a href="<?php echo base_url();?>doctor/view_appointment_details/<?php echo $row['appointment_id'].'/'. $row['patient_id'].'/'.$row['department_id'].'/'. $row['doctor_id'].'/';?>"><button type="button" class="btn btn-info btn-circle btn-xs"><i class="fa fa-link"></i> </button></a>
