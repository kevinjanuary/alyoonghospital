				<div class="row">
                    ...
                    <?php echo form_open(base_url() . 'doctor/add_appointment/do_update/'.$row['appointment_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
