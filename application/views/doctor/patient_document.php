                    ...
                    <div class="col-sm-12">
                     ...
                     class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_new_document');?>
						...
						?>
                             ...
                             <a href="<?php echo base_url();?>admin/view_patient_document/<?php echo $row['patient_id'];?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-link"></i> </button></a>
