				<div class="row">
                    <div class="col-sm-12">
                     ...
                     class="btn btn-orange btn-xs"><i class="fa fa-eye"></i>&nbsp;<?php echo get_phrase('list_doctor');?>
                    </a>
							</div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control m-r-10" name="date_of_birth" type="date" value="2011-08-19" id="example-date-input" required>
                                    </div>
                                </div>
...
<h5>Photoshop <span class="pull-right">70%</span></h5>
                        ...
                        <div class="col-sm-12">
                        <input type="file" name="file_name" class="form-control btn btn-primary m-r-10" data-label="<i class='glyphicon glyphicon-file'></i> Browse" />
