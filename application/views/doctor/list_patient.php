                                ...
                                <div class="el-card-avatar el-overlay-1"> <img src="<?php echo $this->crud_model->get_image_url('patient',$row['patient_id']);?>" />
                                    <div class="el-overlay">
                                        <ul class="el-info">
                                            ...
                                            <li><a class="btn default btn-outline" href="<?php echo base_url();?>admin/edit_patient_profile/<?php echo $row['patient_id'];?>"><i class="icon-link"></i></a></li>
                                            <li><a class="btn default btn-outline" href="<?php echo base_url();?>admin/view_patient_profile/<?php echo $row['patient_id'];?>"><i class="icon-book-open "></i></a></li>
                                        </ul>
                                    </div>
                                </div>
